...
pacman -Syyu reflector rsync curl wget xorg networkmanager sudo vim git keepassxc openssh github-cli libx11 libxft libxinerama gcc pkg-config xorg-xinit
